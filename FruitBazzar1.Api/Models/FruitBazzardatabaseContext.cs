...
public partial class FruitBazzardatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Customers).WithMany(p => p.CartItem)
        ...
        modelBuilder.Entity<Products>(entity =>
        {
            ...
            entity.HasOne(d => d.Categort).WithMany(p => p.Products)
        ...
        {
            entity.HasOne(d => d.Customer).WithMany(p => p.Purchase)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK_Purchases_ToCustomers");

            entity.HasOne(d => d.Product).WithMany(p => p.Purchase)
                .HasForeignKey(d => d.ProductId)
        ...
        {
            entity.HasOne(d => d.Customer).WithMany(p => p.Review)
                .HasForeignKey(d => d.CustomerId)
